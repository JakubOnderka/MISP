...
<script type="text/javascript">
    ...
    $('.hex-value-convert').click(function() {
        ...
        if (!$hexValueSpan.hasClass('binary-representation')) {
            ...
            $hexValueSpan
                .text(bin)
                .attr('data-original-title', __('Binary representation'))
                .addClass('binary-representation');
            $(this)
                .attr('data-original-title', __('Switch to hexadecimal representation'))
                .attr('aria-label', __('Switch to hexadecimal representation'));
        } else {
            var hex = '';
            val.split(' ').forEach(function(entry) {
            ...
            $hexValueSpan
                .text(hex)
                .attr('data-original-title', __('Hexadecimal representation'))
                .removeClass('binary-representation');
            $(this)
                .attr('data-original-title', __('Switch to binary representation'))
                .attr('aria-label', __('Switch to binary representation'));
        }
    });
</script>
<?php
